...
interface ERC1155 /* is ERC165 */ {
    ...
    */
    ...
    /**
        ...
        @return        The _owner's balance of the token type requested, it MUST return zero when tokenId does not exist
     */
    ...
    /**
        ...
        @return        The _owner's balance of the token types requested (i.e. balance for each (owner, id) pair), the balance returned for non-existing ids MUST be zero
     */
